...
function inicializarGraficaResoluciones() {
    ...
    const coloresBase = [
        ...
        'rgba(111, 92, 163, 0.80)',   // Violeta
        'rgba(207, 111, 104, 0.78)',  // Coral suave
        'rgba(207, 157, 72, 0.78)',   // Ámbar
        'rgba(74, 130, 139, 0.76)',   // Petróleo
        'rgba(133, 148, 164, 0.72)',  // Gris azulado
    ];
